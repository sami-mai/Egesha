...
class OwnerProfile(models.Model):
    ...
    avatar = models.ImageField(upload_to='avatar/', blank=True, null=True)
    bio = models.TextField(max_length=500, null=True, blank=True)
    user = models.OneToOneField(User, related_name='owner_profile', on_delete=models.CASCADE, unique=True, null=False, db_index=True)
    phone_number = models.DecimalField(max_digits=30, decimal_places=2, null=True)
...
class ManagerProfile(models.Model):
    ...
    avatar = models.ImageField(upload_to='avatar/', blank=True, null=True)
    bio = models.TextField(max_length=500, null=True, blank=True)
    user = models.OneToOneField(User, related_name='manager_profile', on_delete=models.CASCADE, unique=True, null=False, db_index=True)
    phone_number = models.DecimalField(max_digits=30, decimal_places=2, null=True)
    national_id = models.CharField(max_length=30, null=True)
    join_date = models.DateTimeField(auto_now=True)
